...
swfobject.embedSWF(
	"http://static.telia.dk/11_facelift/flash/hastighedsmaaler/hastighedsmaaler_orange.swf", "hastighedAlbum", 
	"700", 56+(flashvars.numItems*34), 
	swfVersionStr, xiSwfUrlStr, 
	flashvars, params, attributes);
<!-- JavaScript enabled so display the flashContent div in case it is not replaced with a swf object. -->
swfobject.createCSS("#hastighedAlbum", "display:block;text-align:left;");